 ...
 *
 * $Id: mac_security.c 26610 2011-05-11 08:47:45Z sschneid $
 *
...
retval_t mac_secure(frame_info_t *frame, uint8_t *mac_payload_ptr, mcps_data_req_t *pmdr)
{
    ...
    create_nonce((uint8_t *)&tal_pib_IeeeAddress, (uint8_t *)&mac_sec_pib.FrameCounter, pmdr->SecurityLevel, nonce);
