 ...
 *
 * $Id: sio_handler.h,v 1.4.2.1 2011/07/14 18:29:14 dam Exp $
 *
...
// the AT91SAM3*-headers define UARTx themselves, even if not set in Makefile
#if ((defined UART0) && (PAL_GENERIC_TYPE != SAM3))
  #define SIO_CHANNEL     SIO_0
#elif ((defined UART1) && (PAL_GENERIC_TYPE != SAM3))
