...
void low_power_mode(void)
{
    ...
    AT91C_BASE_ADC->ADC_IDR = 0;
    AT91C_BASE_PMC->PMC_PCDR = 1<<AT91C_ID_ADC;

    // configure ADC inputs PB27-PB30 to be PIO controlled
    static const Pin PIN_ADC_PB27_NEUTRAL = { 1<<27, AT91C_BASE_PIOB, AT91C_ID_PIOB, PIO_INPUT, PIO_DEFAULT};
