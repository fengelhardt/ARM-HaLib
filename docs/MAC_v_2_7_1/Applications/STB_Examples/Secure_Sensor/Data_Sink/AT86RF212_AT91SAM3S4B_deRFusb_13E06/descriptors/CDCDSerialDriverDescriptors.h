 ...
 *
 * Definition of the USB descriptors required by a CDC device serial driver.
 *
 *
 * $Id: CDCDSerialDriverDescriptors.h,v 1.1.4.1 2011/07/14 18:54:52 dam Exp $
 *
 *  @author
