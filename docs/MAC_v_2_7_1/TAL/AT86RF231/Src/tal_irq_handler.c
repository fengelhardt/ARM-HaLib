 ...
 *
 * $Id: tal_irq_handler.c 27684 2011-07-12 15:22:58Z uwalter $
 *
...
#if (ANTENNA_DIVERSITY == 1) || defined(DISABLE_TSTAMP_IRQ)
    /*
     * Get timestamp.
     *
...
#endif  /* #if (ANTENNA_DIVERSITY == 1) || defined(DISABLE_TSTAMP_IRQ) */
