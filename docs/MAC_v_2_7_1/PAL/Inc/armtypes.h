 ...
 *
 * $Id: armtypes.h,v 1.5.2.2 2011/07/14 18:17:42 dam Exp $
 *
 */
/**
 *  @author
...
#if 0 // traditional MAC implementation
#define sei()   do                          \
{                                           \
...
#else // new approach, additionally save R0 register

#define sei()           asm volatile (                          \
    "STMDB   SP!, {R0}  \n\t" /* Push R0.                   */  \
    "MRS  R0, CPSR      \n\t" /* Get CPSR.                  */  \
    "BIC  R0, R0, #0xC0 \n\t" /* Enable IRQ, FIQ.           */  \
