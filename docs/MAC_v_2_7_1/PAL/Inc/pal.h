 ...
 * used by TAL and MAC.
 *
 * $Id: pal.h,v 1.4.2.2 2011/07/12 16:42:15 dam Exp $
 *
...
#if (defined(SIO_HUB) || defined(DOXYGEN) || (PAL_GENERIC_TYPE==ARM7) || (PAL_GENERIC_TYPE==SAM3))
/*
...
#endif  /* (defined(SIO_HUB) || defined(DOXYGEN) || (PAL_GENERIC_TYPE==ARM7) || (PAL_GENERIC_TYPE==SAM3)) */
