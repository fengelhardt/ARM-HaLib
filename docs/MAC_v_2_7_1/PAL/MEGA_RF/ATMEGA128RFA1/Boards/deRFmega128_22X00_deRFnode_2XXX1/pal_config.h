...
#if (BOARD_TYPE == deRFmega128_22X00_deRFnode_2XXX1)
 ...
 */
#if (!((defined REV00) || (defined REV02)))
// take REV01 if no other explicitely requested
#define BUTTON0_PIN          (PG1)
#define BUTTON0_PORT         (PORTG)
#define BUTTON0_DDR          (DDRG)
#define BUTTON0_PINS         (PING)
...
#elif (defined REV00)
/* Button0 is N/A
 * physical Button1 becomes logical button 0
 */
#define BUTTON0_PIN          (PD6)
#define BUTTON0_PORT         (PORTD)
#define BUTTON0_DDR          (DDRD)
#define BUTTON0_PINS         (PIND)
#endif
...
#elif (defined REV00)
#define USB_WR_PIN                  (PB7)
#define USB_WR_PORT                 (PORTB)
#define USB_WR_DDR                  (DDRB)
#define USB_WR_PINS                 (PINB)
#endif

#if (!((defined REV00) || (defined REV02)))
// take REV01 if no other REV explicitely requested
...
#define USB_RD_PINS                 (PIND)
#elif (defined REV00)
#define USB_RD_PIN                  (PB6)
#define USB_RD_PORT                 (PORTB)
#define USB_RD_DDR                  (DDRB)
#define USB_RD_PINS                 (PINB)
#endif
...
#if (!((defined REV00) || (defined REV02)))
// take REV01 if no other REV explicitly requested
...
#define USB_D7_PINS                 (PINB)
#elif (defined REV00)
#define USB_D7_PIN                  (PD4)
#define USB_D7_PORT                 (PORTD)
#define USB_D7_DDR                  (DDRD)
#define USB_D7_PINS                 (PIND)
#endif
...
#endif /* deRFmega128_22X00_deRFnode_2XXX1 */
