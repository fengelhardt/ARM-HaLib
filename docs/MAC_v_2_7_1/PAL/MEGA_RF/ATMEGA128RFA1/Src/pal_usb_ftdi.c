 ...
 *
 * $Id: pal_usb_ftdi.c,v 1.5.2.3 2011/07/14 15:57:14 dam Exp $
 *
...
/* === Macros =============================================================== */
      ...
      (BOARD_TYPE == deRFmega128_22X00_deRFnode_2XXX1) )
#error "Please use the individual implementation of the same functions \
       in the respective board folder !"
#endif
