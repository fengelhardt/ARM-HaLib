 ...
 *
 * $Id: board.h,v 1.1.8.1 2011/07/08 16:45:51 dam Exp $
 *
 *  @author
...
//------------------------------------------------------------------------------
/** Name of the board */
#define BOARD_NAME "deRFusb_23E00"
//------------------------------------------------------------------------------
...
#if (defined PRE_REV00) | (defined REV00)
...
#if (defined REV00) | (defined PRE_REV00)
/** LED #0 pin definition (GREEN). */
#define PIN_LED_0      {1 << 16, PIOA, ID_PIOA, PIO_OUTPUT_1, PIO_DEFAULT}
...
/** Transceiver TRX IRQ Pin */
#if (defined PRE_REV00)
