 ...
 *
 * $Id: pal_config.h,v 1.1.8.2 2011/07/12 16:44:07 dam Exp $
 *
 *  @author
...
#if (F_XTAL == 16000000)
  #define PLLA_MULTIPLIER               (59)
  #define PLLA_DIVIDER                  (10)
#elif (F_XTAL == 18432000)
/* PLLA multiplier and divider to generate a 96 MHz clock (used for USB) */
...
#if (F_XTAL == 16000000)
  #define PLLB_MULTIPLIER               (39)
  #define PLLB_DIVIDER                  (10)
#elif (F_XTAL == 18432000)
/* PLLB multiplier and divider to generate a 64 MHz clock (used for MCK) */
...
#endif /* #if (BOARD_TYPE == deRFusb_23E00) */
