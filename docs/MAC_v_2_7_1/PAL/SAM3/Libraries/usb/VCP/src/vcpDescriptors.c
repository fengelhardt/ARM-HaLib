...
#if(PAL_TYPE == AT91SAM3S4B) && (TAL_TYPE == AT86RF231)
#if(BOARD_TYPE==SAM3_RFEK01)
#define VENDOR_ID       0x1CF1
#define PRODUCT_ID      0x0025
#endif
#elif (PAL_TYPE == AT91SAM3S4B) && (TAL_TYPE == AT86RF212)
#if(BOARD_TYPE==SAM3_RFEK02)
#define VENDOR_ID       0x1CF1
#define PRODUCT_ID      0x0018
#endif
#elif (PAL_TYPE == AT91SAM3S4C)
...
#elif defined(AT90USB1287) || defined(AT91SAM3S4C) || defined(AT91SAM3S4B)
