 ...
 *
 * $Id: pal_sio_hub.c 28470 2011-09-08 07:16:41Z mahendran.p $
 *
 */
/**
 * @author
...
#ifdef UART0
        case SIO_0:
            sio_uart_0_init(UART_BAUD_115k2);
            break;
#endif

#ifdef UART1
        case SIO_1:
            sio_uart_1_init(UART_BAUD_115k2);
            break;
#endif
...
#ifdef USB0
        case SIO_2:
            number_of_bytes_received = sio_usb_0_rx(data, max_length);
            break;
#endif
        default:
