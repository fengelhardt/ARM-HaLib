 ...
 * @file pal_usb.c
 *
 * @brief Functions for native USB support on SAM3-platforms.
 *
 * This file implements functionality for handling native USB
 * on SAM3 platforms.
 *
 * $Id: pal_usb.c,v 1.2.2.1 2011/07/08 16:48:31 dam Exp $
 *
 * @author
...
//------------------------------------------------------------------------------
/// Configures USB clock.
//------------------------------------------------------------------------------
void ConfigureUsbClock(void)
{
    PMC->PMC_USB = BOARD_USB_CLK; // set in pal_config.h
}
