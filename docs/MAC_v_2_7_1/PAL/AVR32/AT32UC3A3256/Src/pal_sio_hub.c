 ...
 *
 * $Id: pal_sio_hub.c 28646 2011-09-22 07:54:18Z yogesh.bellan $
 *
...
uint8_t pal_sio_tx(uint8_t sio_unit, uint8_t *data, uint8_t length)
{
    ...
    switch (sio_unit)
    {
        ...
        case SIO_3:
        case SIO_4:
            number_of_bytes_transmitted = sio_usart_tx(data, length);
            break;
#endif
#ifdef USB0
        case SIO_2:
            number_of_bytes_transmitted = sio_usb_tx(data, length);
            break;
#endif
        default:
...
#ifdef USB0
        case SIO_2:
            number_of_bytes_received = sio_usb_rx(data, max_length);
            break;
#endif
        default:
