 ...
 *
 * $Id: pal_config.h,v 1.1.4.1 2011/07/08 16:55:30 dam Exp $
 *
 * @author
...
#if (BOARD_TYPE == deRFarm7_15X00_deRFnode_1XXX2)
...
/* F_CPU dependent variables */
  ...
  // F_Xtal=16MHz =>  96[MHz] PLL = 16[MHz] *60/10
...
#endif /* deRFarm7_15X00_deRFnode_1XXX2 */
