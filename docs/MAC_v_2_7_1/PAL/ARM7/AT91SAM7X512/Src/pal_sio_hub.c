 ...
 *
 * $Id: pal_sio_hub.c,v 1.1.10.3 2011/07/14 18:16:54 dam Exp $
 *
 * @author
...
// TODO: this switch may be set if running into trouble
// if transmitting larger data (i.e. Performance Test with WXP SP2)
#ifdef DELAYED_SIO_TRX
#include "pal_timer.h"
#endif
...
uint8_t pal_sio_tx(uint8_t sio_unit, uint8_t *data, uint8_t length)
{
    ...
    switch (sio_unit)
    {
        ...
        case SIO_2:
                    ...
                    /* additionally delay each transmission by ~8ms */
                    pal_timer_delay(0x1FFF);
#else
                    // traditional implementation
                    number_of_bytes_transmitted = sio_usb_0_tx(data, length);
#endif /* DELAYED_SIO_TRX */
