 ...
 *
 * $Id: sensors.h,v 1.1.4.1 2011/07/08 16:59:08 dam Exp $
 *
...
// ============================================================================
#define DS620_ADDRESS                 (0x48)   // (0x90 >> 1)
#define TMP102_ADDRESS                (0x48)   // (0x90 >> 1)
#define ISL29020_ADDRESS              (0x44)   // (0x88 >> 1)
#define BMA150_ADDRESS                (0x38)   // (0x70 >> 1)
